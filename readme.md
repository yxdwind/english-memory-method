...
| 🔁 | **复习闭环** | 句级「顺/卡」打卡 → 薄弱句清单 → 连顺 2 轮毕业，进度存本地不丢 |
...
<details>
<summary><b>展开查看 v2.1 → v2.6.0 全部变更</b></summary>
...
**v2.7.0**：复习闭环——方案文件内置句级打卡组件：每句「顺 / 卡」自评，卡壳句自动进**薄弱句清单**（点击跳转原文），连顺 2 轮自动毕业；轮次自动记日期结算，进度存浏览器本地、刷新不丢、打印自动隐藏。30 篇方案全量内置，双击打开即可追踪背诵进度。
